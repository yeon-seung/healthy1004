  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span> <span class="mr-2"><a href="index.html">Crew Board <i class="fa fa-chevron-right"></i></a></span> <span>Crew Board Details <i class="fa fa-chevron-right"></i></span></p>
   ...
   <div class="col-md-4 ftco-animate d-flex align-items-center align-items-stretch">
    <div class="staff-2 w-100">
     <div class="img-wrap d-flex align-items-stretch">
      <div class="img align-self-stretch d-flex align-items-end" style="background-image: url(images/run.jpg);">
...
<div class="col-md-8 d-flex align-items-center">
  <div class="staff-detail w-100 pl-md-5">
   <h3>Title</h3>
   <p>7/1일에 LA에서 러닝할 크루 구합니다</p>
   <h3>Content</h3>
   <p>7/1일에 오리역 근처에서 탄천 따라 러닝하실 분들 구합니다~~
      5km 정도 러닝할 예정입니다~~
   </p>
  </div>
</div>
